...
describe('Footer', () => {
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.lists.selector}\`, and \`${declarations.linkHeader.selector}\`, they should be used in \`index.html\` @link-class-attributes`, () => {
    assert(lists.class, 'The `.lists` class should exist before applying it in the HTML.');
    assert(linkHeader.class, 'The `.link-header` class should exist before applying it in the HTML.');
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.twitter.selector}\`, \`${declarations.facebook.selector}\`, \`${declarations.instagram.selector}\`, and \`${declarations.pinterest.selector}\`, they should be used in \`index.html\` @social-class-attributes`, () => {
    assert(twitter.class, 'The `.twitter` class should exist before applying it in the HTML.');
    assert(facebook.class, 'The `.facebook` class should exist before applying it in the HTML.');
    assert(instagram.class, 'The `.instagram` class should exist before applying it in the HTML.');
    assert(pinterest.class, 'The `.pinterest` class should exist before applying it in the HTML.');
  ...
  it(`\`main.css\` should contain rules with the selectors, \`${declarations.newsletterLinkHeader.selector}\`, and \`${declarations.newsletterLinkSubheader.selector}\`, they should be used in \`index.html\` @newsletter-class-attributes`, () => {
    assert(newsletterLinkHeader.class, 'The `.newsletter .link-header` class should exist before applying it in the HTML.');
    assert(newsletterLinkSubheader.class, 'The `.newsletter .link-subheader` class should exist before applying it in the HTML.');
  ...
  it(`\`main.css\` should contain the classes, \`${declarations.ps.selector}\`, \`${declarations.demo.selector}\`, and \`${declarations.copyright.selector}\`, they should be used in \`index.html\` @pluralsight-demo-class-attributes`, () => {
    assert(ps.class, 'The `.ps` class should exist before applying it in the HTML.');
    assert(demo.class, 'The `.demo` class should exist before applying it in the HTML.');
    assert(copyright.class, 'The `.copyright` class should exist before applying it in the HTML.');
